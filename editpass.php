		...
		<div class="col-12">
			...
			<form class="file-upload" action="profilecode.php" method="POST">
					...
					<div class="col-xxl-8 mb-5 mb-xxl-0">
						<div class="bg-secondary-soft px-4 py-5 rounded">
							<div class="row ">
                                ...
                                <label style="font-weight:bold;color:black"><strong>Old Password : </strong></label>
								<input type="password" class="form-control" name="opassword" id="opassword" placeholder="Old Password" required>
								</div>
                                <!-- New Password -->
								<div class="col-md-8">
                                ...
                                <div id="message">
									...
									<p id="special" class="invalid">A <b>special letter</b></p>
                ...
                */
				...
				<!-- button -->
				<div class="col-md-6">
					<button type="submit" class="btn btn-primary btn-lg" name="savepassbtn">Save</button>
					<a href="editprofile.php" class="btn btn-danger btn-lg">Return</a>
				</div>
				<?php
				?>
			</form> <!-- Form END -->    
